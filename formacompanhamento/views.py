...
def prestador_detail(request):
    ...
    data = {
        ...
        'valor_prontaresposta_armado': str(prestador.valor_prontaresposta_armado) if prestador.valor_prontaresposta_armado is not None else None,
        ...
        'valor_prontaresposta_desarmado': str(prestador.valor_prontaresposta_desarmado) if prestador.valor_prontaresposta_desarmado is not None else None,
        ...
        'valor_antenista': str(prestador.valor_antenista) if prestador.valor_antenista is not None else None,
